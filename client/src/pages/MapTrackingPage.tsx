      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="card h-[520px] overflow-hidden lg:col-span-2">
          <MapContainer center={center} zoom={11} style={{ height: '100%', width: '100%' }} scrollWheelZoom>
            ...
            {current && (
              <>
                <Marker position={[current.latitude, current.longitude]} icon={sorexIcon}>
                  <Popup>
                    <div className="text-xs">
                      <div className="mb-1 font-bold">SOREX-001</div>
        ...
        <div className="space-y-4">
          ...
          <div className="card p-4">
            ...
            <div className="mt-3 space-y-2 text-sm text-slate-400">
              <div className="flex items-center gap-2"><span className="text-teal-400">━</span> SOREX trajectory</div>
