    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-abyss-950">
      ...
      <div className="relative w-full max-w-md animate-slide-up px-6">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-white">SOREX</h1>
        ...
        <p className="mt-5 text-center text-xs text-slate-500">
          Demo credentials — <span className="data-value text-teal-400">admin</span> / <span className="data-value text-teal-400">sorex2026</span>
        </p>
